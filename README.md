...
|  | Signal | WhatsApp | Telegram | **VOID** |
|--|:--:|:--:|:--:|:--:|
| Phone number required | ✗ | ✗ | ✗ | **✓ None** |
| Central server sees metadata | ✗ | ✗ | ✗ | **✓ No server** |
| P2P direct option | ✗ | ✗ | ✗ | **✓ WebRTC** |
| Panic wipe | ✗ | ✗ | ✗ | **✓ 3-second hold** |
| Works on Tor | Partial | ✗ | ✗ | **✓ Native** |
| Single auditable file | ✗ | ✗ | ✗ | **✓ Yes** |
...
```bash
# 1. Fork or create a GitHub repo named VOID
...
The app is live. Share the URL with your contacts. No server setup. No npm install. No Docker. Nothing.
...
- ✗ JavaScript GC limits true cryptographic memory zeroing  
- ✗ Traffic resistance ≠ true onion routing (Tor-grade)
- ✗ No software is "unhackable" — anyone who claims otherwise is lying
...
That's it. Two files. The whole thing.
